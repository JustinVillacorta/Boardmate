...
interface LoginFormProps {
  ...
  onViewChange?: (view: 'login' | 'forgot-password') => void;
}

const LoginForm: React.FC<LoginFormProps> = ({ onLogin, onViewChange }) => {
    ...
    return (
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-end">
          <button type="button" onClick={handleForgotPasswordClick} className="text-sm text-blue-600 hover:text-blue-500 transition-colors">
            Forgot Password?
          </button>
        </div>
